...
void main() {
  test('adds one to input values', () {
    ...
    //wallet login
    WalletConnectionParams walletConnectionParam = WalletConnectionParams(
    ...
    NEARConnectionConfig nearConnectionConfig = NEARConnectionConfig(networkId, keyPair, walletURL, helperUrl, explorerUrl, rpcUrl);
